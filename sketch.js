...
function preload()
{
  ...
  ghostRed = loadImage('taytay.jfif');
  ghostGreen = loadImage('taytay.jfif');
  ghostOrange = loadImage('taytay.jfif');
  ghostBlue = loadImage('taytay.jfif');
  ...
  sirenSound = loadSound('IDK.mp3');
  gameoverSound = loadSound('gameover.mp3');
  scoreSound = loadSound('Another One.mp3');
